                ...
                Container(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index){
                          return Tabs(title: tabsLength[index], index:index ,selectedIndex: _selectedIndex, isPressed: (){
                            changeTabs(index);
                            // print(index);
                ...
                Expanded(
                  child: PageView(
                    ...
                    children: <Widget>[
                      ...
                      CustomPage(content: Text('Page 2 Content'),),
                      CustomPage(content: Text('Page 2 Content'),),
                      CustomPage(content: Text('Page 2 Content'),),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(child: Text(title, style: TextStyle(fontWeight: (index==selectedIndex)? FontWeight.w600: FontWeight.w500),)),
      ),
    );
  }
}
